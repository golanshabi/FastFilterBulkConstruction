 ...
 */
    template<class Table>
    size_t get_FPR_test0(Table *wrap_filter, const std::vector<u64> *v_add, const std::vector<u64> *v_find, bool sorted, std::vector<u64> *v_check) {
        /**Insertion*/
    ...
    template<class Table>
    std::string FPR_test_as_str(Table *wrap_filter, const std::vector<u64> *v_add, const std::vector<u64> *v_find, bool sorted, std::vector<u64> *v_check) {
    ...
    template<class Table>
    void FPR_test(std::vector<u64> *v_add, const std::vector<u64> *v_find, std::string path, bool is_hashable, bool create_file = false, bool sorted = false, SortType sort_type = SortType::RadixAVX2, size_t filter_max_capacity = 0) {
        #ifdef SORT_ONLY
            if (!is_hashable) {
